...
<a href="https://github.com/komalashrafsyed/pinasynctool">This</a> walkthrough will list down the steps in creating an apt package from the PingAsync .NET Core 3.0 application code (download the latest .NET Core soure code for the Ping App from <a href="https://dev.azure.com/airband/_git/Komal">here</a>)